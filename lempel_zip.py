...
with open('dataset/1000.txt') as input_file:
    with open('1000 file.txt.lzw', 'wb') as compressed_file:
        compressed_file.write(compress(input_file.read()))

"""
# Decompresses and prints "example file.txt.lzw" content.
with open('example file.txt.lzw', 'rb') as compressed_file:
    print(decompress(compressed_file.read()))"""